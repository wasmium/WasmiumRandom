...
mod test_length {
    ...
    #[test]
    fn test_wyrand_alphabet() {
        assert_eq!(12_usize, WasmiumRandom::wyrand_alphabet12().len());
        assert_eq!(24_usize, WasmiumRandom::wyrand_alphabet24().len());
        assert_eq!(32_usize, WasmiumRandom::wyrand_alphabet32().len());
        assert_eq!(64_usize, WasmiumRandom::wyrand_alphabet64().len());
        assert_eq!(128_usize, WasmiumRandom::wyrand_alphabet128().len());
        assert_eq!(256_usize, WasmiumRandom::wyrand_alphabet256().len());
        assert_eq!(512_usize, WasmiumRandom::wyrand_alphabet512().len());
        assert_eq!(1024_usize, WasmiumRandom::wyrand_alphabet1024().len());
        assert_eq!(2048_usize, WasmiumRandom::wyrand_alphabet2048().len());
    }
}
