...
mod test_length {
    ...
    #[test]
    fn test_wyrand_numeric() {
        assert_eq!(12_usize, WasmiumRandom::wyrand_numeric12().len());
        assert_eq!(24_usize, WasmiumRandom::wyrand_numeric24().len());
        assert_eq!(32_usize, WasmiumRandom::wyrand_numeric32().len());
        assert_eq!(64_usize, WasmiumRandom::wyrand_numeric64().len());
        assert_eq!(128_usize, WasmiumRandom::wyrand_numeric128().len());
        assert_eq!(256_usize, WasmiumRandom::wyrand_numeric256().len());
        assert_eq!(512_usize, WasmiumRandom::wyrand_numeric512().len());
        assert_eq!(1024_usize, WasmiumRandom::wyrand_numeric1024().len());
        assert_eq!(2048_usize, WasmiumRandom::wyrand_numeric2048().len());
    }
}
