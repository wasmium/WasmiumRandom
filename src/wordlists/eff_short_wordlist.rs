/// Wordlist from the Electronic Frontier Foundation Diceware recommendation.
/// This contains `1296` words with short number of characters.
pub const EFF_SHORT: [&str; 1296] = [
